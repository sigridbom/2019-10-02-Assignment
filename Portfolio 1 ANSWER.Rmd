...
The Shapiro-Wilk test has a p-value of 0,00 (p<0,05) which indicates that the data are significantly different from a normal distribution. skew.2SE is 2,02 (>1 = not normal) and kurt.2SE is -0,25 (<1, could indicate normality, but it is not enough on its own).
